            ...
            <div className="page-wraper" style={{background: '#f8f9fa'}}>
                ...
                <nav className="navbar navbar-expand-lg" style={{
                    ...
                    <div className="container-fluid px-4">
                        <div className="navbar-brand d-flex align-items-center" style={{color: '#FF7A00'}}>
                            <i className="fa fa-graduation-cap fa-lg mr-2" style={{color: '#FF7A00'}}></i>
                        ...
                        <div className="navbar-nav ml-auto d-flex align-items-center" style={{columnGap: '1rem'}}>
                            <div className="nav-item">
                                <span className="nav-link d-flex align-items-center" style={{color: '#000000', fontWeight: 500}}>
                                    <i className="fa fa-user-circle mr-2" style={{color: '#FF7A00'}}></i>
                                    Account
                                </span>
                            </div>
                            <button 
                                className="btn btn-sm logout-btn"
                                style={{borderRadius: '50px', padding: '0.4rem 1.1rem', fontWeight: 600, letterSpacing: '0.5px', color: '#ffffff', border: '2px solid #FF7A00', backgroundColor: '#FF7A00', transition: 'all 0.3s'}}
                                onClick={() => {
